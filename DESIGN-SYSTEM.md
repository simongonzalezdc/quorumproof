...
| color_mode | **committed (CEO)** | LIGHT-ONLY, no toggle | All polish budget into one perfect surface |
...
1. No dark mode / no theme toggle
...
## Build contract — semantic tokens (light-only)
